...
document.addEventListener('DOMContentLoaded', () => {
	...
	const deleteBtn = document.getElementById('deleteBtn'); // <-- añadido
	...
	function renderTasks(tasks) {
		...
		tasks.forEach((t, idx) => {
			...
			// Cambiado: al marcar la casilla, eliminar la tarea inmediatamente
			checkbox.addEventListener('change', () => {
				if (checkbox.checked) {
					...
					// si se desmarca, opcionalmente mantener como no completada
					t.completed = false;
					saveTasks(tasks);
